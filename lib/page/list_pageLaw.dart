...
class ListPageLaw extends StatefulWidget {
  const ListPageLaw({Key? key}) : super(key: key);

  @override
  State<ListPageLaw> createState() => _ListPageLawState();
}
...
class _ListPageLawState extends State<ListPageLaw> {
  ...
  Future getDataList() async {
    final response = await http.get(Env().getListWordLaw());
